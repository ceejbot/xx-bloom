...
BloomFilter.prototype.getBits = function( buf ) {
...
BloomFilter.prototype.sync = function( file ) {
	fs.writeFileSync( file + ".json", JSON.stringify( { bytes: this.buffer.length, bits: this.bits, hashes: this.hashes, seeds: this.seeds } ) );
